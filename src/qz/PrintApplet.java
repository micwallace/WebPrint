...
//    private String manualBreak = "%/SPOOL/%";
                        ...
                        switch (appendType) {
                            ...
                            case APPEND_IMAGE_SERIAL:
                                ...
                                if (ByteUtilities.isBase64Image(file)) {
                                    ...
                                    bi2 = ImageIO.read(new URL(file));
                                }
                                iw2 = new ImageWrapper(bi2, lang);
                                iw2.setCharset(charset);
                                // Image density setting (ESCP only)
                                iw2.setDotDensity(dotDensity);
                                // Image coordinates, (EPL only)
                                iw2.setxPos(imageX);
                                iw2.setyPos(imageY);
    ...
    public void appendImageSerial(String imageFile, String lang, String dotDensity) {
        printingimg = true;
        if (dotDensity.equalsIgnoreCase("single")) {
            this.dotDensity = 32;
        } else if (dotDensity.equalsIgnoreCase("double")) {
        ...
        setLanguage(lang);
        appendFromThread(imageFile, APPEND_IMAGE_SERIAL);
    }
