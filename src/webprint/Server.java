                    ...
                    if (!jrequest.has("origin")) {
                        ...
                        if (action.equals("init")) {
                            if (!acl.isAllowed(origin, cookie)) {
                                ...
                                int dialogResult = JOptionPane.showConfirmDialog(null, origin + " is trying to access your printers and serial ports.\nWould you like to allow?\nOnly click yes for sites you trust.", "Warning", dialogButton);
